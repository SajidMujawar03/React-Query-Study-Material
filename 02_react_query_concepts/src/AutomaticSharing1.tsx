    ...
    <div className="container mx-auto px-6 py-10">
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 mb-6 text-center">
        <p className="text-purple-700 font-medium">
          Page 1: This query shares the same cache as Page 2.  
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 ">
        {data.map((user: any, index: number) => (
          <div
            key={index}
            className="bg-gradient-to-r  from-blue-300 to-blue-600 border rounded-2xl shadow-md p-6 flex flex-col items-center 
